		...
		if ( is_array( $scheme ) && ! empty( $scheme ) ) {
			...
			?><script>
			 jQuery( document ).ready( function( $ ) {
                 ...
                 function <?php echo esc_attr( $slug ) ?>_func(formData){
                     const $<?php echo esc_attr( $slug ) ?>          = $('#<?php echo esc_attr( $slug ) ?>');
                     const $<?php echo esc_attr( $slug ) ?>_fields   = $<?php echo esc_attr( $slug ) ?>.find('input, select, textarea');
