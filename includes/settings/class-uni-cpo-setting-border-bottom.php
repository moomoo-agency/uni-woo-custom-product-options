...
/*
* Uni_Cpo_Setting_Border_Bottom class
*
*/

class Uni_Cpo_Setting_Border_Bottom extends Uni_Cpo_Setting implements Uni_Cpo_Setting_Interface {
	...
	public function __construct() {
		$this->setting_key  = 'border_bottom';
		$this->setting_data = array(
			'title' => __( 'Bottom', 'uni-cpo' ),
		);
