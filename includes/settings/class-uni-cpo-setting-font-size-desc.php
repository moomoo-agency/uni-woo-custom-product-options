...
/*
* Uni_Cpo_Setting_Font_Size_Desc class
*
*/

class Uni_Cpo_Setting_Font_Size_Desc extends Uni_Cpo_Setting implements Uni_Cpo_Setting_Interface {
	...
	public function __construct() {
		$this->setting_key  = 'font_size_desc';
