...
/*
* Uni_Cpo_Setting_Cpo_Fc_Default class
*
*/

class Uni_Cpo_Setting_Cpo_Fc_Default extends Uni_Cpo_Setting implements Uni_Cpo_Setting_Interface {
	...
	public function __construct() {
		$this->setting_key  = 'cpo_fc_default';
