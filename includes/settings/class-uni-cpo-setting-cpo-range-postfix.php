...
/*
* Uni_Cpo_Setting_Cpo_Range_Postfix class
*
*/

class Uni_Cpo_Setting_Cpo_Range_Postfix extends Uni_Cpo_Setting implements Uni_Cpo_Setting_Interface {
	...
	public function __construct() {
		$this->setting_key  = 'cpo_range_postfix';
		$this->setting_data = array(
			'title'             => __( 'Postfix', 'uni-cpo' ),
			//'is_tooltip'        => true,
